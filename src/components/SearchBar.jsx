...
export default function SearchBar() {
    return (<div className='flex items-center justify-between border-1 border-gray-600 rounded-4xl w-50 h-9 '>
        <div className='flex items-center px-3'>
            <input type="text" placeholder='Search' className='w-30 outline-0 px-2' />
        </div> 
